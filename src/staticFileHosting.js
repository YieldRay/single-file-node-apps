    ...
    const server = http.createServer(async (req, res) => {
        ...
        for (const e of mapOption) {
            ...
            if (isSkip)
                ...
                console.log(
                    `   try:   target=${targetFile} public=${e.public} local=${e.local}`
                );
        ...
        if (!isSuccess) {
            ...
            res.writeHead(404);
            res.end(
                `<html><head><title>404 Not Found</title></head><body><center><h1>404 Not Found</h1></center><hr><center>node.js</center></body></html>`
            );
